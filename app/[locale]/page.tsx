        ...
        <div className="container mx-auto">
          <div className="section-row">
            ...
            <div className="md:w-1/3">
              <Image src={sectionAbout} alt={t('about')} className="h-auto max-w-full p-4" />
            </div>
          </div>
        </div>
        <div className="container mx-auto">
          <div className="section-row">
            <div className="w-2/4 md:w-1/5">
              <Image src={html} alt="HTML 5" loading="lazy" />
            </div>
            <div className="w-2/4 md:w-1/5 lg:w-1/5">
              <Image src={css} alt="CSS 3" loading="lazy" />
            </div>
            <div className="w-2/4 md:w-1/5 lg:w-1/5">
              <Image src={js} alt="Javascript" loading="lazy" />
            </div>
            <div className="w-2/4 md:w-1/5 lg:w-1/5">
              <Image src={ts} alt="TypeScript" loading="lazy" />
            </div>
            <div className="w-2/4 md:w-1/5 lg:w-1/5">
          ...
          <div className="section-row">
            <div className="w-2/4 md:w-1/5">
              <Image src={wordpress} alt="Wordpress" loading="lazy" />
            </div>
            <div className="w-2/4 md:w-1/5 lg:w-1/5">
              <Image src={woocommerce} alt="Woocommerce" loading="lazy" />
            </div>
            <div className="w-2/4 md:w-1/5 lg:w-1/5">
              <Image src={opencart} alt="Opencart" loading="lazy" />
            </div>
            <div className="w-2/4 md:w-1/5 lg:w-1/5">
              <Image src={nodejs} alt="Node JS" loading="lazy" />
            </div>
            <div className="w-2/4 md:w-1/5 lg:w-1/5">
              <Image src={nextjs} alt="Next JS" loading="lazy" />
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="flex">
            <div className="flex flex-col items-stretch w-full md:w-1/3 p-2">
              <div className="mb-2">
                <Image src={develop} alt={t('Development')} loading="lazy" />
              </div>
              <h3>{t('Development')}</h3>
            ...
            <div className="flex flex-col items-stretch w-full md:w-1/3 p-2">
              <div className="mb-2">
                <Image src={upgrade} alt={t('Update / Repair / Upgrade')} loading="lazy" />
              </div>
            ...
            <div className="flex flex-col items-stretch w-full md:w-1/3 p-2">
              <div className="mb-2">
                <Image src={optimize} alt={t('SEO, UI optimization')} loading="lazy" />
              </div>
        ...
        <div className="container mx-auto">
          ...
          <div className="section-row">
            <div className="md:w-1/4">
              <Image src={sectionProjects} alt={t('projects')} className="h-auto max-w-full p-4" />
            </div>
